...
import "./About.css";
// <div className="outer"><img src="/jtek-logo.jpg" className="stamp-pic" alt="stamp-pic" /></div>
// <h1 className="firmname">ABOUT J-TEK LAW PLLC</h1>
// <div class="container">
