        ...
        <section className="info">
            ...
            <div className="container">
                ...
                <div className="disclaimer-text">
                    ...
                    <p>
                        This web site may contain links or may be linked to other web sites not maintained by J-TEK LAW PLLC. No representations, express or implied, are made with respect to the materials and information provided on any third-party web site linked to this web site, including any representations as to the accuracy, timeliness, reliability, suitability or completeness of any material or information on such linked site. Inclusion of a link in this web site to another web site does not imply recommendation, approval, or endorsement by J-TEK LAW PLLC of the linked site.
                    </p>

                    <p>
                        J-TEK LAW PLLC has an office only in the Commonwealth of Virginia.
                    </p>

                    <p>
                        Mr. Tekanic is licensed to practice in the District of Columbia, California and before the USPTO. Mr. Tekanic is not licensed to practice in Virginia. Mr. Tekanic’s practice in Virginia is limited to matters before the United States Patent and Trademark Office and to areas of federal law that by rule, regulation or statute do not require Virginia State Bar membership.
                    </p>
                    ...
                    <p>
                        Jeffrey D. Tekanic is solely responsible for the content of this website.
                    </p>
                </div>
            </div>
        </section>
